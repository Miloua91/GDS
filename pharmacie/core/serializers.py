...
class LotSerializer(serializers.ModelSerializer):
    produit_denomination = serializers.CharField(source='produit.denomination', read_only=True)
    produit_code_national = serializers.CharField(source='produit.code_national', read_only=True)
    produit_code_interne = serializers.CharField(source='produit.code_interne', read_only=True)
    produit_forme = serializers.CharField(source='produit.forme_pharmaceutique', read_only=True)
    ...
    produit_stock_securite = serializers.IntegerField(source='produit.stock_securite', read_only=True)
    produit_stock_alerte = serializers.IntegerField(source='produit.stock_alerte', read_only=True)
    
    class Meta:
        model = LotProduit
        fields = [
            'id', 'produit', 'numero_lot', 'date_fabrication', 'date_peremption',
            'date_reception', 'quantite_initiale', 'quantite_actuelle', 'quantite_reservee',
            'statut', 'prix_unitaire_achat',
            'produit_denomination', 'produit_code_national', 'produit_code_interne',
            'produit_forme', 'produit_dosage', 'produit_dci',
            'produit_stock_securite', 'produit_stock_alerte',
        ]
...
class UtilisateurSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "fonction", "specialite", "telephone", "numero_ordre",
...
class UtilisateurCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "fonction", "specialite", "telephone", "numero_ordre",
            "is_active", "is_staff", "role", "service",
        ]
